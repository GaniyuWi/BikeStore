...
namespace Assignment.Areas.Admin.Controllers
{
    ...
    public class OrderController : Controller
    {
        ...
        public ActionResult Create(OrderVM obj)
        {
            ...
            {
                obj.CustomerList = _db.Customer.GetAll().Select(u => new SelectListItem
                {
                    Text = u.FirstName + " " + u.LastName,
                    Value = u.CustomerId.ToString()

                });
                obj.StaffList = _db.Staff.GetAll().Select(u => new SelectListItem
                {
                    Text = u.FirstName + " " + u.LastName,
                    Value = u.StaffId.ToString()
